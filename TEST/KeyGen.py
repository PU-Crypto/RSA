...
name = input('Speichername ?: ')

begin = random.randint(1000000,1000001) #begin = int(input('Anfang : ')) #Input wert

grenze = begin + 20000 #begin + int(input('Grenze, begin + x : ')) # Schritte weiter von dem Input
